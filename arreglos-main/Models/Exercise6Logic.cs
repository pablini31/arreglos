...
namespace ArrayExercises.WinForms.Models
{
    public class Exercise6Logic
    {
        ...
        /// <summary>
        /// Genera datos de ventas aleatorios para 12 meses y 7 días de la semana
        /// </summary>
        /// <returns>Matriz 12x7 con valores aleatorios de ventas entre 10 y 100</returns>
        public int[,] GenerateRandomSalesData()
        {
            int[,] salesData = new int[12, 7]; // 12 meses, 7 días de la semana

            for (int month = 0; month < 12; month++)
            {
                for (int day = 0; day < 7; day++)
                {
                    // Generar valores aleatorios entre 10 y 100
                    salesData[month, day] = random.Next(10, 101);
                }
            }
